      ...
      <ul>
        {recommendationProduct?.map((product, index) => (
          <li key={index} className="text-md">
            <div className="p-4 bg-white dark:bg-[#1D283A] rounded-2xl mb-2 h-[150px] border border-gray-300 dark:border-none shadow-lg dark:shadow-none">
            ...
            <div className="p-4 bg-white dark:bg-[#1D283A] rounded-2xl h-[150px] border border-gray-300 dark:border-none shadow-lg dark:shadow-none">
              <p className="uppercase font-bold text-lg mb-2">
