...
export const SPXChart: React.FC = () => {
  const { data, error } = useSWR<SPXPoint[]>(
    "/api/market-indices/spx",
    fetcher
  );
      ...
      <div className="p-4">
        <ResponsiveContainer width="100%" height={300}>
          ...
          >
            <defs>
              <linearGradient
                id={`spxGradient-${color.substring(1)}`}
                x1="0"
                y1="0"
                x2="0"
                y2="1"
                  ...
                  return (
                    <div className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 text-gray-800 dark:text-white">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        {dataPoint &&
                          dataPoint.change_percent !== undefined && (
                            <div className="flex justify-between gap-4">
                              <span className="text-gray-500 dark:text-gray-400">
                                Change:
                              </span>
            ...
            <Area
              type="monotone"
              dataKey="close_price"
              fill={`url(#spxGradient-${color.substring(1)})`}
              strokeWidth={0}
            />
            <Line
              type="monotone"
