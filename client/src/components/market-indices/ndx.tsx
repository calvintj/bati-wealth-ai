...
export const NDXChart: React.FC = () => {
  const { data, error } = useSWR<NDXPoint[]>(
    "/api/market-indices/ndx",
    fetcher
  );
      ...
      <div className="p-4">
        <ResponsiveContainer width="100%" height={300}>
          ...
          >
            <defs>
              <linearGradient
                id={`ndxGradient-${color.substring(1)}`}
                x1="0"
                y1="0"
                x2="0"
                y2="1"
            ...
            <Area
              type="monotone"
              dataKey="close_price"
              fill={`url(#ndxGradient-${color.substring(1)})`}
              strokeWidth={0}
            />
            <Line
              type="monotone"
