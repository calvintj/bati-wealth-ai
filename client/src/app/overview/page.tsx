      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex flex-col gap-2 flex-1 overflow-y-scroll mr-2 my-2 overscroll-contain">
          ...
          <div className="flex flex-col md:flex-row gap-2">
            <section className="flex-1 rounded-2xl bg-[#1D283A]" aria-label="Total Customers">
              <TotalCustomer customerRisk={customerRisk} customerData={customerData} />
            </section>

            <section className="flex-1 rounded-2xl bg-[#1D283A]" aria-label="Total AUM">
              <TotalAUM customerRisk={customerRisk} aumData={aumData} />
            </section>

            <section className="flex-1 rounded-2xl bg-[#1D283A]" aria-label="Total FBI">
          ...
          <div className="flex flex-col md:flex-row gap-2">
            <section className="flex-[2] rounded-2xl bg-[#1D283A]" aria-label="Quarterly FUM">
              <QuarterlyFUM customerRisk={customerRisk} quarterlyFUM={quarterlyFUM} />
            </section>

            <section className="flex-1 rounded-2xl bg-[#1D283A]" aria-label="Customer Overview">
              <CustomerRiskProfile
          ...
          <div className="flex flex-col md:flex-row gap-2">
            <section className="flex-[2] rounded-2xl bg-[#1D283A]" aria-label="Quarterly FBI">
              <QuarterlyFBI
                customerRisk={customerRisk}
            ...
            <section className="flex-1 rounded-2xl bg-[#1D283A]" aria-label="Top Products">
              <TopProducts customerRisk={customerRisk} topProducts={topProducts} />
            </section>
          </div>
