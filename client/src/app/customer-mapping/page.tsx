    ...
    <div className="flex h-screen dark:bg-gray-900 text-gray-200">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex flex-col gap-2 flex-1 overflow-y-auto m-2">
          {/* Stacked Bar Chart */}
          <div>
            <p className="text-2xl font-bold text-center text-black dark:text-white">Pemetaan Nasabah</p>
          </div>
          ...
          {/* Customer List Table */}
          <div>
            <p className="text-2xl font-bold text-center text-black dark:text-white">Daftar Nasabah</p>
          </div>
          <div>
